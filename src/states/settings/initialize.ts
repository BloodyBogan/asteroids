...
const initialize = (
    ...
    resetHighScores: TClassMethod<typeof ScoreManager, 'resetHighScores'>,
    ...
    const resetHighScoresButtonCallback = () => {
        resetHighScores();
    };

    const backToMainMenuButtonCallback = () => {
    ...
    return {
        ...
        buttons: {
            ...
            resetHighScores: {
                ...
                eventTypes: ['click', 'touchstart'],
                callback: resetHighScoresButtonCallback,
            },
            backToMainMenu: {
                backToMainMenuButton,
                elementType: HTMLButtonElement,
                eventTypes: ['click', 'touchstart'],
                callback: backToMainMenuButtonCallback,
            },
        },
        buttonHandler,
    };
